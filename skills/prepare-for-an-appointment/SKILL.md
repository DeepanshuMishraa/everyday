...
description: Prepare for a medical, financial, school, legal, or professional appointment by organizing the goal, timeline, documents, and highest-priority questions. Use when the user wants a concise brief they can bring into a limited-time meeting without asking the agent to diagnose or decide for the professional.
---
...
Use [APPOINTMENT-BRIEF-FORMAT.md](APPOINTMENT-BRIEF-FORMAT.md). Include language, mobility, sensory, memory, privacy, or support-person needs when the user raises them.
