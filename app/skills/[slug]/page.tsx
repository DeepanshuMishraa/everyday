  ...
  return <>
    ...
    <div className="wrap skill-layout">
      <aside className="skill-sidebar">
        ...
        <section className="file-facts"><h2>About this skill</h2><dl><div><dt>Status</dt><dd><span className={reviewed ? "status passed" : "status pending"}>{reviewed ? "Instructions reviewed" : "Review pending"}</span></dd></div><div><dt>Version</dt><dd>{skill.version}</dd></div><div><dt>Included files</dt><dd>{skill.fileCount}</dd></div><div><dt>Updated</dt><dd>{skill.updated}</dd></div></dl><Link className="text-link" href="/methodology">How reviews work →</Link></section>
      </aside>
